...
export function Footer() {
  return (
    <>
      <footer className="footer p-10 bg-[#1B71E8] text-base text-white">
        <div>
          <Image
      ...
      <footer className="footer px-10 py-4 text-base-content bg-[#1B71E8]">
        ...
        <div className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            <a href="http://www.twitter.com/carbovalent" target="_blank" rel="noreferrer">
              <svg
